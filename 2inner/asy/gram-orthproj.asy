...
currentprojection=perspective(2*a-b+3u);
...
draw(Label("$\pi_U^\perp(\vx)$",align=-0.4c),O--proj(x),red+0.5green,Arrow3);
draw(Label("$\pi_U(\vx)$",align=-u),O--c,blue+0.5green,Arrow3);
